...
st.set_page_config(page_title = "Yolo V5 Road Sign Detection", page_icon="🤖")
...
st.markdown("<h2 style='text-align: center; color: black; font-family: font of choice, fallback font no1, sans-serif;'>Road Sign Detection</h2>", unsafe_allow_html=True)
...
DEMO_VIDEO = os.path.join('.', 'Samples', 'sampleVideo0.mp4')
DEMO_PIC = os.path.join('.', 'Samples', 'samplePic.png')
    ...
    if source_index == 0:
        ...
        if uploaded_file is not None:
            ...
            with st.spinner(text = 'Resource Loading...'):
                ...
                with open(os.path.join(".", "yolov5", "data", "videos", uploaded_file.name), "wb") as f:
                    f.write(uploaded_file.getbuffer())
                
                data_source = os.path.join(".", "yolov5", "data", "videos", uploaded_file.name)
